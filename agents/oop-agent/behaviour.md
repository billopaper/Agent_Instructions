...
Object-oriented design and structured abstractions.

## Instructions

- Model the problem using classes, methods, and clear interfaces.
- Encapsulate state and behavior.
- Keep responsibilities separated.
- Use tests or examples to validate each object.
- If grader runs remain after correctness, improve runtime, memory, and LOC.

## Prompt guidance

Ask the agent to design a small class model and implement the solution accordingly.

## Task
Grade command (run exactly this, every time):
`Set-Location -Path "c:\Users\micha\Documents\GIT\MasterPrompt\agents\oop-agent\val"; python ../../../grading/validate.py validation/weighted-shortest-path solution.py`
