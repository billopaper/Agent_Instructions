...
NOTE: This is the best attempt of the run, but it never reached full
correctness — it stably passes 20/21 hidden tests. No version of the solution
was ever graded `correct`, so this file is the cleanest / best-metric 20/21
variant rather than a verified winner. See reasoning.md for the full trail.
