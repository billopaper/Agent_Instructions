...
`Set-Location -Path "c:\Users\micha\Documents\GIT\MasterPrompt\agents\vanilla\val"; python ../../../grading/validate.py validation/weighted-shortest-path solution.py`
